...
1. [Add an Alert](Local-Tutorial-Add-an-Alert)
1. [Aggregated Alerts](Local-Tutorial-Advanced-Aggregate-alerts)
1. [Output to disk](Local-Tutorial-Outputs-to-disk)
1. [Add a Tag to your data](Local-Tutorial-Tag-Rules-output-to-local-file)
1. [Add Aggregated Tags to your data](Local-Tutorial-Tag-Aggregate-to-metrics)
1. [Add SQL to add metrics](Local-Tutorial-Adding-SQL-to-your-flow-and-outputs-to-Metrics-dashboard)
...
1. [Use UDF and UDAF to call Scala code](Local-Tutorial-Extending-with-UDF-UDAF-custom-code)
