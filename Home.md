...
1. [UDF, UDAF, Azure Functions](functions)
1. [Accumulator](data-accumulator)
1. [Scale](scale)
1. [Inviting others and Roles based access](inviting-others-RBAC)
1. [Data Normalization](data-normalization)
1. [Cloud Deployment parameters](arm-parameters)
